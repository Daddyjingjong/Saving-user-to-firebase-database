...
//        show all users in user activity
...
//        grab data from edit texts
        ...
        val id = System.currentTimeMillis() //time in milliseconds
...
//        validate input
        if (firstname.isEmpty() || lastname.isEmpty() || email.isEmpty() || password.isEmpty()){
            showMessage("Empty fields","Please make sure all fields have required data")
        }else{
//         firebase database
...
//            143431234 || John || Developer || email || password
            val user_object = UserShema(firstname, lastname,email, password)
